...
constexpr const int RAYS_PER_PIXEL = 100;
constexpr const int MAX_SHADOW_RAYS_PER_RAY = 50;

constexpr const double CAM_APERTURE = 0.05;
constexpr const double CAM_FOCUS_DISTANCE = 2;
constexpr const double CAM_VERTICAL_FIELD_OF_VIEW = 90.0;

constexpr const Vector3 CAM_VUP{0.0, 1.0, 0.0};
constexpr const Point3 CAM_LOOKAT{0.0, 0.0, -1.0};
constexpr const Point3 CAM_LOOKFROM{0.0, 0.0, 1.0};
